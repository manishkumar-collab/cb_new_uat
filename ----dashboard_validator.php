...
// Get pending requests (approved by Head) - Only for this validator
 $pending_sql = "SELECT cr.*, u.full_name, u.emp_id, u.department 
              FROM cashback_requests cr 
              JOIN users u ON cr.user_id = u.id 
              WHERE cr.status = 'Head Approved' AND u.validator_id = $validator_id" . $filter_conditions . "
...
// Get statistics - Only for this validator
 $stats_sql = "SELECT 
            ...
            SUM(CASE WHEN status = 'Head Approved' THEN 1 ELSE 0 END) AS pending_count,
